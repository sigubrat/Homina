...
- Added lion to the boss configs and corresponding discord emoji
...
- `/season-participation` now filters out 'unknown players' (players who have left the guild)
...
The update also comes with a little code to help fuel your machines of war: HISTORYREVIEW

### Added

- `/token-history` - **New command!** - See a history of tokens used for a player over N number of seasons
...
- Added Laviscus and Aesoth to the custodes team definition. Both will remain optional until the meta has settled and players have Laviscus built further.
...
- Updated the guild boss season config 3 to match the updated rotation
