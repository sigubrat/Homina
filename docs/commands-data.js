...
window.HOMINA_COMMANDS = [
    ...
    },
    {
        ...
        commands: [
            { name: "member-stats-per-season", desc: "Display detailed statistics for each member in a specific season.", opts: ["season", "rarity", "export"], img: "assets/graph-damage-history.png", imgAlt: "Per-member damage breakdown chart" },
    ...
    },
    {
        ...
        commands: [
            { name: "season-tokens", desc: "Find out how many tokens each member has used in a specific season.", opts: ["season", "rarity", "average-method"], img: "assets/graph-season-tokens.png", imgAlt: "Season tokens chart" },
            { name: "tokens-per-loop", desc: "Show how many tokens the guild spent on each loop in a given season.", opts: ["season"] },
            { name: "tokens-per-loop-by-boss", desc: "Show how many tokens the guild spent on each boss per loop in a given season.", opts: ["*rarity", "season"] },
            { name: "tokens-per-boss", desc: "See tokens used per boss across loops in a given season.", opts: ["*rarity", "season"] },
    ...
    },
    {
        ...
        commands: [
            { name: "available-bombs", desc: "See who has bombs available.", opts: ["soon"], img: "assets/graph-available-bombs.png", imgAlt: "Available bombs readout" },
    ...
    },
    {
        ...
        commands: [
            { name: "season-participation", desc: "Check how much each member has participated in a specific guild raid season.", opts: ["season", "rarity", "show-bombs", "average-method", "include-unknown"], img: "assets/graph-season-participation.png", imgAlt: "Season participation chart" },
    ...
    },
    {
        ...
        commands: [
            ...
            { name: "bot-metrics", desc: "View detailed bot usage metrics and trends from 1st of March 2026 and onwards.", opts: ["period"] }
        ]
    }
];
